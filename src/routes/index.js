...
const tickets = [
	...
	},
	{
		...
		description:
			'The website has a "/contact" page, where a form is being submitted and handled by the "App/Actions/Contact/ProcessContactForm" action.',
		subtasks: [
	...
	},
	{
		...
		description:
			'The seeder is populating amenities in the database, but none are displaying on the /amenities page',
	...
	},
	{
		...
		description:
			'On the "/contact" page, successful form submissions are greeted by a white modal.  Figure out the cause of this, and instead, either display a success message on the page, or redirect them to a confirmation page.',
	...
	},
	{
		...
		description:
			"When you visit a locations page, you currently only see information about their hours. Also add a list of that location's amenities.",
	...
	},
	{
		...
		description:
			'On the "/amenities page", clicking on one of the amenities should show which clubs have that selected amenity.  You can do this via a new page or a modal.',
		tags: ['full-stack', 'new-feature'],
		images: [],
		blockedBy: [12]
	}
